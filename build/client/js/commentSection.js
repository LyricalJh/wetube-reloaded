...
var spanX = document.querySelectorAll("#remove");
var videoComment = document.querySelector(".video__comment");
var reply = document.querySelector(".comment__text");
var replyBtn = document.querySelector(".reply__comment");
var userImg = document.querySelector(".title__img");
...
var editComment = function editComment(event) {
  var commnet = event.target.parentElement.firstChild;
...
var saveComment = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(event) {
    var commentId, commnet, text, response;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            commentId = event.target.parentElement.dataset.id; //get the target id
            commnet = event.target.parentElement.firstChild;
            text = event.target.parentElement.firstChild.innerText;
            _context3.next = 5;
            return fetch("/api/videos/".concat(commentId, "/edit"), {
              method: "POST",
              headers: {
                "Content-Type": "application/json"
              },
  ...
  return function saveComment(_x3) {
...
if (editBtn) {
  editBtn.forEach(function (element) {
    return element.addEventListener("click", editComment);
  });
}
if (spanX) {
  spanX.forEach(function (element) {
    return element.addEventListener("click", removeComment);
  });
}